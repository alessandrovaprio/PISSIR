...
export interface AttrezzaturaInterface extends General{
  "idAttrezzatura"?: number;
...
export class Attrezzatura implements AttrezzaturaInterface{
  "idAttrezzatura"?: number;
  "nomeAttrezzatura"?: string;
  // "attrezzature"?: Attrezzatura;
  constructor(data?: AttrezzaturaInterface) {
  ...
  getFields() : string[] {
    return ["idAttrezzatura", "nomeAttrezzatura"];
  }
  getRelations(): string [] {
    return [];
  }
